...
import {Modal,Icon,Input,Button, message, Tooltip} from "antd";
import "./style/updateAndSee.less";
        ...
        >
          <div>
            ...
            <Modal visible={previewVisible} footer={null} onCancel={this.handleCancel}>
              <img ref='zoomImg' onWheel={this.imgZoom} alt="example" style={{ width: '100%' }} src={previewImage} />
            </Modal>
            <div className="title">存证详情</div>
            <div className="tabs">
              <div className="uploadimg" >
                ...
                <div style={{display:'flex'}}>
                  ...
                  {Bigremark == "" && !isUpdate ? <div className="no-log no-log2"><img style={{marginRight:5}} src="/images/no-log.png" alt=""/>暂无存证记录</div>:null}
                  {isUpdate?
                  <TextArea
                   value={Bigremark}
                ...
                {!isUpdate
                  ...
                  <div style={{marginTop:15}}>
                    <Button onClick={this.goTOUPpdate} style={{marginLeft:130,width:104,marginRight:142}}>修改</Button>
                    <Button style={{width:104}} type="primary" onClick={(e)=>{this.props.clickUpdata(e,false)}}>关闭</Button>
                  </div>
                  :
                  <div style={{marginTop:15}}>
